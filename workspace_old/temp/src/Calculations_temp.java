...
public class Calculations_temp
{
   ...
   {
     final Calculations_temp calc = new Calculations_temp();
     ...
     millimeters.addActionListener(new ActionListener() {
		 public void actionPerformed(ActionEvent e) {
			Calculations_temp.units = 1;
			calc.initSArrayMillimeter1();
			Calculations_temp.isUnitsSelected = true;
		}
     });
     ...
     yearButton.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
			Calculations_temp.yearOutput = true;
	       }
     });
     JButton monthButton = new JButton("Month Output");
     monthButton.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e) {
			Calculations_temp.monthOutput = true;
	       }
     });
     //!!!!!!!!!
	 ...
	 try
	    {
		 ...
		 outf.printf("%s\t", new Object[] { this.stationName });
		 outf.printf("%s\t", new Object[] { "Version 1.0" });
	     outf.printf("ObservedMonths:%d", new Object[] { Integer.valueOf(months.size()) });
	     outf.printf("\tDataUnits:mm%n", new Object[0]);
	     outf.printf("CNvalue", new Object[0]);
	     outf.print("\t\t");
	     ...
	     for (int i = 0; i < months.size(); i++) {
	    	 outf.printf("Month: %.0f", new Object[] { Double.valueOf(Double.parseDouble(months.get(i).getMonth())) });
	    	 for (int j = 0; j < this.cnArray.length; j++)
	    	 	{
	    		 	ArrayList<Double> qValues = new ArrayList();
